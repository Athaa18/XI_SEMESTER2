...
let nilai= [
    ...
    {nama:"adi", ipa:80, bahasa:90, matematika:60},
    {nama:"arka", ipa:75, bahasa:70, matematika:90},
    {nama:"bintang", ipa:90, bahasa:80, matematika:90},
];
let nama= ["budi","adi","arka","bintang"];
// nama.push("ani","andre");
